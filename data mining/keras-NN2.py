...
voting_data = pd.read_csv('./data mining/house-votes-84.data.txt',names = feature_names)
print(voting_data.head())

voting_data.dropna(inplace=True)
voting_data.describe()

voting_data.replace(('y', 'n', '?'), (1, -1, 0), inplace=True)
voting_data.replace(('democrat', 'republican'), (1, -1), inplace=True)
print(voting_data.head())
